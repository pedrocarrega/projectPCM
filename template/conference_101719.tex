...
With that said, like mentioned before, that method is not ideal for the problem at hand due to the fact that the number of positions in need of computation is much greater than the number of threads available. As we increase the graph size the overhead added by the scheduling of the GPU will 
