...
100x lower than uncached global memory latency\cite{https://devblogs.nvidia.com/using-shared-memory-cuda-cc/} (provided that there are no bank conflicts between the threads). It is allocated per 
