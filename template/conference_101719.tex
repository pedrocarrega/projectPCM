...
\begin{figure}[htbp]
	\centerline{\includegraphics{figures/gridExampleTransparant.png}}
...
__global__ void calcWithAtomic1D(int* output, int* syncGrid)
{
	...
	int i, j, counter, k = 0, avaliador, Dik;
